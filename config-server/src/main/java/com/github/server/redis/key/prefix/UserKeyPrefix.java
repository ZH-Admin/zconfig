package com.github.server.redis.key.prefix;

import com.github.server.redis.key.BasePrefix;

import static com.github.server.constant.ApplicationConstant.TOKEN_EXPIRE;
